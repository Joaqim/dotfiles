...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  minecraft-modpack = {
    ...
    src = fetchurl {
      url = "https://github.com/Joaqim/MinecraftModpack/releases/download/v2025.05.15-rc1/Minecraft-Modpack-v2025.05.15-rc1.mrpack";
      sha256 = "sha256-B1391mc+PhmopK8LmJ8vTDAY4eGTmSwCyln/W/UFQOA=";
    };
  };
  mpv-skipsilence = {
  ...
  yt-dlp = {
    pname = "yt-dlp";
    version = "2685654a37141cca63eda3a92da0e2706e23ccfd";
    src = fetchFromGitHub {
      owner = "yt-dlp";
      repo = "yt-dlp";
      rev = "2685654a37141cca63eda3a92da0e2706e23ccfd";
      fetchSubmodules = false;
      sha256 = "sha256-uJnqS5pFVMoFA2HSwZUkcoGKUVJ+WKJQJIZfBOUdtmo=";
    };
    date = "2025-05-18";
  };
}
